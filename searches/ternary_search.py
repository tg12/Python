...
# This is the linear search that will occur after the search space has
# become smaller.
...
if __name__ == "__main__":
    ...
    if result2 is not None:
        print(
            "Iterative search: {} found at positions: {}".format(
                target, result1))
        print(
            "Recursive search: {} found at positions: {}".format(
                target, result2))
    else:
        print("Not found")
